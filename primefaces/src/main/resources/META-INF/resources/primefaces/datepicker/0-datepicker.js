...
(function (factory) {
    ...
    $.widget("prime.datePicker", {
        ...
        renderHourPicker: function () {
            ...
            var html = this.options.timeInput ? '<input value="' + hourDisplay + '" size="2" maxlength="2" tabindex="0" class="ui-inputfield"></input>' : '<span>' + hourDisplay + '</span>';
        ...
        renderMinutePicker: function () {
            ...
            var html = this.options.timeInput ? '<input value="' + minuteDisplay + '" size="2" maxlength="2" tabindex="0" class="ui-inputfield"></input>' : '<span>' + minuteDisplay + '</span>';
        ...
        renderSecondPicker: function () {
            if (this.options.showSeconds) {
                ...
                //type="number" min="0" max="59" does not work well on Firefox 70, so we don´t use it
                var html =  this.options.timeInput ? '<input value="' + secondDisplay + '" size="2" maxlength="2" tabindex="0" class="ui-inputfield"></input>' : '<span>' + secondDisplay + '</span>';
        ...
        renderMillisecondPicker: function () {
            if (this.options.showMilliseconds) {
                ...
                var html =  this.options.timeInput ? '<input value="' + millisecondDisplay + '" size="3" maxlength="3" tabindex="0" class="ui-inputfield"></input>' : '<span>' + millisecondDisplay + '</span>';
